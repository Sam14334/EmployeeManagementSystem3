...
('1001', 'karlo', 'admin123', 'Gian Karlo', 'Alatiit', 'karlo@staffsync.com', '09171234567', 1, 'HR Staff', 1, 65000.00),
('1002', 'jomar', 'hrpass321', 'Jomar', 'Pangilinan', 'jomar@staffsync.com', '09187654321', 2, 'HR Staff', 1, 45000.00),
('1003', 'rich', '123', 'Rich Jasper', 'Federio', 'rich@staffsync.com', '09223334444', 3, 'Manager', 1, 38000.00),
('1004', 'admin', '123', 'Karlo', 'Alatiit', 'karloalatiit111@gmail.com', '09978158181', 1, 'HR Staff', 1, 100000.00),
('1005', 'parao', '123', 'Ezekiel', 'Parao', 'parao@gmail.com', '09234322342', 2, 'Employee', 2, 40000.00),
('1006', 'parao2', '123', 'Zeke', 'Parao', 'zeke@gmail.com', '099278471976', 2, 'Employee', 2, 30000.00),
('1011', 'sam', '123', 'micheal', 'samia', 'michealsamia@gmail.com', '09923134121', 2, 'HR Staff', 3, 12333.00);
...
INSERT INTO `employee_requests` (`request_id`, `employee_id`, `request_type`, `description`, `status`, `notes`) VALUES
(1, '1005', 'Leave', 'went to a 3-day vacation', 'Approved', 'have fun with your vacation');
...
--
ALTER TABLE `employee_requests`
  ADD CONSTRAINT `employee_requests_ibfk_1` FOREIGN KEY (`employee_id`) REFERENCES `employees` (`employee_id`) ON DELETE CASCADE;
