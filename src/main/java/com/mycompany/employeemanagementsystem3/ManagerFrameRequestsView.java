...
public class ManagerFrameRequestsView extends JFrame implements ActionListener {
    ...
    private void initializeLayout() {
        ...
        scrollPane.setBounds(30, 100, 690, 750); // Adjusted height for single header layout
